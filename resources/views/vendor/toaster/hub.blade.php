<div role="status" id="toaster" x-data="toasterHub(@js($toasts), @js($config))" @class([
    'fixed z-[100] p-4 w-full flex flex-col pointer-events-none sm:p-6',
    ...
    <template x-for="toast in toasts" :key="toast.id">
        ...
        @else
            ...
            <i x-text="toast.message"
                ...
                :class="toast.select({ error: 'bg-red-500', info: 'bg-gray-200', success: 'bg-green-600',
                    warning: 'bg-orange-500' })"></i>
