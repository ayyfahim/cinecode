    ...
    <div class="min-h-screen flex flex-col flex-wrap justify-center content-center gap-8">
        ...
        <div class="card lg:max-w-lg w-full bg-base-100 shadow-xl" id="step-1">
            <div class="card-body">
                ...
                <p class="font-medium text-base-content text-opacity-65 text-sm">Enter the email address you registered
                    with.
                </p>
                <input type="email" placeholder="Email Address" class="input input-bordered w-full mt-4 mb-2" />

                <a href="#" class="font-medium text-primary text-sm">Forgot or lost your email address?</a>

                <div class="w-full flex flex-wrap justify-between mt-3">
                    <div class="card-actions justify-end">
                        <button class="btn font-bold">Back to Log In</button>
                    </div>
                    <div class="card-actions justify-start">
                        <button class="btn btn-primary text-opacity-100 font-bold" wire:click='dummy_alert()'>Send
                            Instructions</button>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-3">
                    <label class="form-control w-full">
                        ...
                        <label class="input input-bordered flex items-center gap-2">
                            ...
                            <input type="password" class="grow" value="password" placeholder="Current Password" />
                        </label>
                    </label>
                    <label class="form-control w-full">
                        <div class="label">
                        ...
                        <label class="input input-bordered flex items-center gap-2">
                            ...
                            <input type="password" class="grow" value="password" placeholder="New Password" />
                        </label>
                    </label>
                    <label class="form-control w-full">
                        <div class="label">
                        ...
                        <label class="input input-bordered flex items-center gap-2">
                            ...
                            <input type="password" class="grow" value="password" placeholder="Confirm Password" />
                        </label>
                    </label>
                </div>

                <div class="card-actions">
                    <button class="btn btn-primary text-opacity-100 font-bold w-full mt-4">Change Password</button>
                </div>
            </div>
        </div> 
        --}}
