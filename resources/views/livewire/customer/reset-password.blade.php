    ...
    <div class="min-h-screen flex flex-col flex-wrap justify-center content-center gap-8">
        <div class="card lg:max-w-lg w-full bg-base-100 shadow-xl" id="step-1">
            <div class="card-body">
                ...
                <p class="font-medium text-base-content text-opacity-65 text-sm">Reset Password</p>
                <form wire:submit="resetPassword">
                    ...
                    <div class="w-full flex flex-wrap justify-between mt-3">
                        <div class="card-actions justify-start">
                            <button type="submit" class="btn btn-cine-highlight-1 text-opacity-100 font-bold">Reset
                                Password</button>
                        </div>
                    </div>
                </form>
