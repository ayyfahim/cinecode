<div>
    <div x-show="modalOpen" class="fixed z-[60] inset-0 flex items-center justify-center">
        ...
        <div x-show="modalOpen"
            ...
            x-data="{ cinemaMode: $wire.entangle('cinema_mode').live }" x-cloak>
            ...
            <div class="p-8 sm:pt-8 pt-4 overflow-y-auto text-white flex flex-wrap justify-center items-center md:gap-6 gap-3"
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-wrap gap-x-2 items-center">
                        <input type="text" class="input input-bordered input-xs text-neutral"
                            placeholder="{{ __('distributor_frontend.enter_cinema_name') }}" wire:model='cinemaName' />
                    </div>
                </div>
                <div class="flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-wrap gap-x-2 items-center self-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 cursor-pointer" viewBox="0 0 1000 1000"
                            fill="currentColor" wire:click='add_emails'>
            ...
            <div class="px-4 py-3 sm:px-6 flex align-items justify-end p-4 gap-4 flex-row" x-show="cinemaMode">
                    ...
                    <div
                        ...
                        @foreach ($cinemaGroups as $item)
                            <div class="px-4 ">
                                ...
                                <div class="divider before:bg-white after:bg-white m-0 before:h-[1px] after:h-[1px]">
                                </div>
                            </div>
                        @endforeach
                            ...
                            <div class="px-4 ">
                                <div class="flex justify-between items-center" x-data="{ open: false }">
                                    ...
                                    <input type="checkbox" value="{{ $item->id }}"
                                        ...
                                        wire:model.live="selectedCinemas" wire:key="cinema-{{ $item->id }}" />
                                </div>
                                <div class="divider before:bg-white after:bg-white m-0 before:h-[1px] after:h-[1px]">
                                </div>
                            </div>
            ...
            <div class="px-4 py-3 sm:px-6 flex align-items justify-end p-4 gap-4 flex-col" x-show="!cinemaMode">
