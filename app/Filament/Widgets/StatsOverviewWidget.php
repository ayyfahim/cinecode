...
class StatsOverviewWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $creditsUsed = (int) (($startDate ? ($diffInDays * 137) : 192100) * $businessCustomerMultiplier);
        ...
        return [
            Stat::make('Credits Used', $formatNumber($creditsUsed))
                ->description('32k increase')
                ->descriptionIcon('heroicon-m-arrow-trending-up')
                ->chart([7, 2, 10, 3, 15, 4, 17])
                ->color('success'),
            Stat::make('Players Downloaded', $formatNumber($newCustomers))
